...
export class AppConnectionAzureClientSecrets extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppConnectionAzureClientSecretsState, opts?: pulumi.CustomResourceOptions): AppConnectionAzureClientSecrets {
        return new AppConnectionAzureClientSecrets(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/appConnectionAzureClientSecrets:AppConnectionAzureClientSecrets';
     ...
     */
    public static isInstance(obj: any): obj is AppConnectionAzureClientSecrets {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppConnectionAzureClientSecrets.__pulumiType;
    }

    /**
     * The credentials for the Azure Client Secrets App Connection
     */
    declare public readonly credentials: pulumi.Output<outputs.AppConnectionAzureClientSecretsCredentials>;
    /**
    ...
    constructor(name: string, argsOrState?: AppConnectionAzureClientSecretsArgs | AppConnectionAzureClientSecretsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppConnectionAzureClientSecretsState | undefined;
            ...
            const args = argsOrState as AppConnectionAzureClientSecretsArgs | undefined;
        ...
        super(AppConnectionAzureClientSecrets.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppConnectionAzureClientSecretsState {
     ...
     * The credentials for the Azure Client Secrets App Connection
     */
    credentials?: pulumi.Input<inputs.AppConnectionAzureClientSecretsCredentials | undefined>;
    /**
     * The hash of the Azure Client Secrets App Connection credentials
     */
