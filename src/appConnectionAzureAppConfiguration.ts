...
export class AppConnectionAzureAppConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppConnectionAzureAppConfigurationState, opts?: pulumi.CustomResourceOptions): AppConnectionAzureAppConfiguration {
        return new AppConnectionAzureAppConfiguration(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/appConnectionAzureAppConfiguration:AppConnectionAzureAppConfiguration';
     ...
     */
    public static isInstance(obj: any): obj is AppConnectionAzureAppConfiguration {
     ...
     */
    declare public readonly credentials: pulumi.Output<outputs.AppConnectionAzureAppConfigurationCredentials>;
    /**
    ...
    constructor(name: string, argsOrState?: AppConnectionAzureAppConfigurationArgs | AppConnectionAzureAppConfigurationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppConnectionAzureAppConfigurationState | undefined;
            ...
            const args = argsOrState as AppConnectionAzureAppConfigurationArgs | undefined;
