...
export class AppConnectionSupabase extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppConnectionSupabaseState, opts?: pulumi.CustomResourceOptions): AppConnectionSupabase {
        return new AppConnectionSupabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/appConnectionSupabase:AppConnectionSupabase';

    /**
     * Returns true if the given object is an instance of AppConnectionSupabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppConnectionSupabase {
     ...
     */
    declare public readonly credentials: pulumi.Output<outputs.AppConnectionSupabaseCredentials>;
    /**
    ...
    constructor(name: string, argsOrState?: AppConnectionSupabaseArgs | AppConnectionSupabaseState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppConnectionSupabaseState | undefined;
            ...
            const args = argsOrState as AppConnectionSupabaseArgs | undefined;
...
export interface AppConnectionSupabaseState {
     ...
     * The credentials for the Supabase App Connection
     */
    credentials?: pulumi.Input<inputs.AppConnectionSupabaseCredentials | undefined>;
    /**
     * The hash of the Supabase App Connection credentials
     */
