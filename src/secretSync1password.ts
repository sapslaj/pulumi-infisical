...
export class SecretSync1password extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretSync1passwordState, opts?: pulumi.CustomResourceOptions): SecretSync1password {
        return new SecretSync1password(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/secretSync1password:SecretSync1password';

    /**
     * Returns true if the given object is an instance of SecretSync1password.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecretSync1password {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecretSync1password.__pulumiType;
    }
     ...
     */
    declare public readonly destinationConfig: pulumi.Output<outputs.SecretSync1passwordDestinationConfig>;
    /**
     ...
     */
    declare public readonly syncOptions: pulumi.Output<outputs.SecretSync1passwordSyncOptions>;
    ...
    constructor(name: string, argsOrState?: SecretSync1passwordArgs | SecretSync1passwordState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecretSync1passwordState | undefined;
            ...
            const args = argsOrState as SecretSync1passwordArgs | undefined;
        ...
        super(SecretSync1password.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface SecretSync1passwordState {
     ...
     * The destination configuration for the secret sync.
     */
    destinationConfig?: pulumi.Input<inputs.SecretSync1passwordDestinationConfig | undefined>;
    /**
     * The slug of the project environment to sync secrets from.
     */
     ...
     * Parameters to modify how secrets are synced.
     */
    syncOptions?: pulumi.Input<inputs.SecretSync1passwordSyncOptions | undefined>;
}
