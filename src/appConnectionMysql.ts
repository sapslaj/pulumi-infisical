...
export class AppConnectionMysql extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppConnectionMysqlState, opts?: pulumi.CustomResourceOptions): AppConnectionMysql {
        return new AppConnectionMysql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/appConnectionMysql:AppConnectionMysql';

    /**
     * Returns true if the given object is an instance of AppConnectionMysql.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AppConnectionMysql {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AppConnectionMysql.__pulumiType;
    }

    /**
     * The credentials for the MySQL App Connection
     */
    declare public readonly credentials: pulumi.Output<outputs.AppConnectionMysqlCredentials>;
    /**
    ...
    constructor(name: string, argsOrState?: AppConnectionMysqlArgs | AppConnectionMysqlState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AppConnectionMysqlState | undefined;
            ...
            const args = argsOrState as AppConnectionMysqlArgs | undefined;
        ...
        super(AppConnectionMysql.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface AppConnectionMysqlState {
     ...
     * The credentials for the MySQL App Connection
     */
    credentials?: pulumi.Input<inputs.AppConnectionMysqlCredentials | undefined>;
    /**
     * The hash of the MySQL App Connection credentials
     */
