...
export class CertManagerApplication extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertManagerApplicationState, opts?: pulumi.CustomResourceOptions): CertManagerApplication {
        return new CertManagerApplication(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/certManagerApplication:CertManagerApplication';

    /**
     * Returns true if the given object is an instance of CertManagerApplication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CertManagerApplication {
    ...
    constructor(name: string, argsOrState?: CertManagerApplicationArgs | CertManagerApplicationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CertManagerApplicationState | undefined;
            resourceInputs["description"] = state?.description;
            resourceInputs["name"] = state?.name;
        } else {
            const args = argsOrState as CertManagerApplicationArgs | undefined;
