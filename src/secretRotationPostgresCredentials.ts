...
export interface SecretRotationPostgresCredentialsState {
     ...
     * Parameters to modify how secrets are rotated.
     */
    parameters?: pulumi.Input<inputs.SecretRotationPostgresCredentialsParameters | undefined>;
    /**
     * The ID of the Infisical project to create the secret rotation in.
     */
     ...
     * At which UTC time the rotation should occur.
     */
    rotateAtUtc?: pulumi.Input<inputs.SecretRotationPostgresCredentialsRotateAtUtc | undefined>;
    /**
     * How many days to wait between each rotation.
     */
     ...
     * Secret mappings to modify how secrets are rotated.
     */
    secretsMapping?: pulumi.Input<inputs.SecretRotationPostgresCredentialsSecretsMapping | undefined>;
    /**
     * Temporary parameters to modify how secrets are rotated.
     */
    temporaryParameters?: pulumi.Input<inputs.SecretRotationPostgresCredentialsTemporaryParameters | undefined>;
}
