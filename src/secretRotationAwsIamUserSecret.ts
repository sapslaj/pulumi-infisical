...
export class SecretRotationAwsIamUserSecret extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretRotationAwsIamUserSecretState, opts?: pulumi.CustomResourceOptions): SecretRotationAwsIamUserSecret {
        return new SecretRotationAwsIamUserSecret(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/secretRotationAwsIamUserSecret:SecretRotationAwsIamUserSecret';
     ...
     */
    public static isInstance(obj: any): obj is SecretRotationAwsIamUserSecret {
     ...
     */
    declare public readonly parameters: pulumi.Output<outputs.SecretRotationAwsIamUserSecretParameters>;
    /**
     ...
     */
    declare public readonly rotateAtUtc: pulumi.Output<outputs.SecretRotationAwsIamUserSecretRotateAtUtc>;
    /**
     ...
     */
    declare public readonly secretsMapping: pulumi.Output<outputs.SecretRotationAwsIamUserSecretSecretsMapping>;
    /**
     * Temporary parameters to modify how secrets are rotated.
     */
    declare public readonly temporaryParameters: pulumi.Output<outputs.SecretRotationAwsIamUserSecretTemporaryParameters | undefined>;
     ...
     */
    constructor(name: string, args: SecretRotationAwsIamUserSecretArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SecretRotationAwsIamUserSecretArgs | SecretRotationAwsIamUserSecretState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecretRotationAwsIamUserSecretState | undefined;
            ...
            const args = argsOrState as SecretRotationAwsIamUserSecretArgs | undefined;
 ...
 */
export interface SecretRotationAwsIamUserSecretState {
    /**
     * Whether secrets should be automatically rotated.
     */
     ...
     * Parameters to modify how secrets are rotated.
     */
    parameters?: pulumi.Input<inputs.SecretRotationAwsIamUserSecretParameters | undefined>;
    /**
     * The ID of the Infisical project to create the secret rotation in.
     */
     ...
     * At which UTC time the rotation should occur.
     */
    rotateAtUtc?: pulumi.Input<inputs.SecretRotationAwsIamUserSecretRotateAtUtc | undefined>;
    /**
     * How many days to wait between each rotation.
     */
     ...
     * Secret mappings to modify how secrets are rotated.
     */
    secretsMapping?: pulumi.Input<inputs.SecretRotationAwsIamUserSecretSecretsMapping | undefined>;
    /**
     * Temporary parameters to modify how secrets are rotated.
     */
    temporaryParameters?: pulumi.Input<inputs.SecretRotationAwsIamUserSecretTemporaryParameters | undefined>;
}

/**
 * The set of arguments for constructing a SecretRotationAwsIamUserSecret resource.
 */
export interface SecretRotationAwsIamUserSecretArgs {
    /**
     * Whether secrets should be automatically rotated.
     */
    autoRotationEnabled?: pulumi.Input<boolean | undefined>;
     ...
     * Parameters to modify how secrets are rotated.
     */
    parameters: pulumi.Input<inputs.SecretRotationAwsIamUserSecretParameters>;
    /**
     * The ID of the Infisical project to create the secret rotation in.
     */
     ...
     * Secret mappings to modify how secrets are rotated.
     */
    secretsMapping: pulumi.Input<inputs.SecretRotationAwsIamUserSecretSecretsMapping>;
    /**
     * Temporary parameters to modify how secrets are rotated.
     */
    temporaryParameters?: pulumi.Input<inputs.SecretRotationAwsIamUserSecretTemporaryParameters | undefined>;
