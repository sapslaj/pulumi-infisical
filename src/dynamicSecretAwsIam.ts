...
export class DynamicSecretAwsIam extends pulumi.CustomResource {
     ...
     */
    declare public readonly configuration: pulumi.Output<outputs.DynamicSecretAwsIamConfiguration>;
    /**
     ...
     */
    declare public readonly metadatas: pulumi.Output<outputs.DynamicSecretAwsIamMetadata[] | undefined>;
    /**
...
export interface DynamicSecretAwsIamState {
     ...
     * The configuration of the dynamic secret
     */
    configuration?: pulumi.Input<inputs.DynamicSecretAwsIamConfiguration | undefined>;
    /**
     * The default TTL that will be applied for all the leases.
     */
     ...
     * The metadata associated with this dynamic secret
     */
    metadatas?: pulumi.Input<pulumi.Input<inputs.DynamicSecretAwsIamMetadata>[] | undefined>;
    /**
     * The name of the dynamic secret.
     */
