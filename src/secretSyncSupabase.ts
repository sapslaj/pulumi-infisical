...
export class SecretSyncSupabase extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretSyncSupabaseState, opts?: pulumi.CustomResourceOptions): SecretSyncSupabase {
        return new SecretSyncSupabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/secretSyncSupabase:SecretSyncSupabase';

    /**
     * Returns true if the given object is an instance of SecretSyncSupabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecretSyncSupabase {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecretSyncSupabase.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SecretSyncSupabaseArgs | SecretSyncSupabaseState, opts?: pulumi.CustomResourceOptions) {
...
export interface SecretSyncSupabaseState {
     ...
     * The destination configuration for the secret sync.
     */
    destinationConfig?: pulumi.Input<inputs.SecretSyncSupabaseDestinationConfig | undefined>;
    /**
     * The slug of the project environment to sync secrets from.
     */
     ...
     * Parameters to modify how secrets are synced.
     */
    syncOptions?: pulumi.Input<inputs.SecretSyncSupabaseSyncOptions | undefined>;
}
