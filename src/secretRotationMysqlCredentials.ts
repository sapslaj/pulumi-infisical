...
export class SecretRotationMysqlCredentials extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretRotationMysqlCredentialsState, opts?: pulumi.CustomResourceOptions): SecretRotationMysqlCredentials {
        return new SecretRotationMysqlCredentials(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infisical:index/secretRotationMysqlCredentials:SecretRotationMysqlCredentials';
     ...
     */
    public static isInstance(obj: any): obj is SecretRotationMysqlCredentials {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecretRotationMysqlCredentials.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: SecretRotationMysqlCredentialsArgs | SecretRotationMysqlCredentialsState, opts?: pulumi.CustomResourceOptions) {
...
export interface SecretRotationMysqlCredentialsState {
     ...
     * Parameters to modify how secrets are rotated.
     */
    parameters?: pulumi.Input<inputs.SecretRotationMysqlCredentialsParameters | undefined>;
    /**
     * The ID of the Infisical project to create the secret rotation in.
     */
     ...
     * At which UTC time the rotation should occur.
     */
    rotateAtUtc?: pulumi.Input<inputs.SecretRotationMysqlCredentialsRotateAtUtc | undefined>;
    /**
     * How many days to wait between each rotation.
     */
     ...
     * Secret mappings to modify how secrets are rotated.
     */
    secretsMapping?: pulumi.Input<inputs.SecretRotationMysqlCredentialsSecretsMapping | undefined>;
    /**
     * Temporary parameters to modify how secrets are rotated.
     */
    temporaryParameters?: pulumi.Input<inputs.SecretRotationMysqlCredentialsTemporaryParameters | undefined>;
}
