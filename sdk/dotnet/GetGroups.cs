...
namespace Pulumi.Infisical
{
    public static class GetGroups
    {
        public static Task<GetGroupsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupsResult>("infisical:index/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());

        public static Output<GetGroupsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupsResult>("infisical:index/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());
