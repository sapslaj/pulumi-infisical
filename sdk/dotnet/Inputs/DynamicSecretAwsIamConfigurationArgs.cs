...
namespace Pulumi.Infisical.Inputs
{
    ...
    public sealed class DynamicSecretAwsIamConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration for the 'access_key' authentication method.
        /// </summary>
        [Input("accessKeyConfig")]
        public Input<Inputs.DynamicSecretAwsIamConfigurationAccessKeyConfigArgs>? AccessKeyConfig { get; set; }

        /// <summary>
        /// Configuration for the 'assume_role' authentication method.
        /// </summary>
        [Input("assumeRoleConfig")]
        public Input<Inputs.DynamicSecretAwsIamConfigurationAssumeRoleConfigArgs>? AssumeRoleConfig { get; set; }
        ...
        public DynamicSecretAwsIamConfigurationArgs()
        {
        }
        public static new DynamicSecretAwsIamConfigurationArgs Empty => new DynamicSecretAwsIamConfigurationArgs();
    }
}
