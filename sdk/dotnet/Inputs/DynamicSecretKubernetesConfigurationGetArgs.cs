...
namespace Pulumi.Infisical.Inputs
{
    ...
    public sealed class DynamicSecretKubernetesConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration for the 'api' authentication method.
        /// </summary>
        [Input("apiConfig")]
        public Input<Inputs.DynamicSecretKubernetesConfigurationApiConfigGetArgs>? ApiConfig { get; set; }
        ...
        /// </summary>
        [Input("dynamicConfig")]
        public Input<Inputs.DynamicSecretKubernetesConfigurationDynamicConfigGetArgs>? DynamicConfig { get; set; }
        ...
        /// </summary>
        [Input("staticConfig")]
        public Input<Inputs.DynamicSecretKubernetesConfigurationStaticConfigGetArgs>? StaticConfig { get; set; }

        public DynamicSecretKubernetesConfigurationGetArgs()
        {
        }
        public static new DynamicSecretKubernetesConfigurationGetArgs Empty => new DynamicSecretKubernetesConfigurationGetArgs();
    }
}
