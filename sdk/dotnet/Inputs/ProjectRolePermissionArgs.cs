...
namespace Pulumi.Infisical.Inputs
{
    ...
    public sealed class ProjectRolePermissionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("conditions")]
        public Input<Inputs.ProjectRolePermissionConditionsArgs>? Conditions { get; set; }
        ...
        public ProjectRolePermissionArgs()
        {
        }
        public static new ProjectRolePermissionArgs Empty => new ProjectRolePermissionArgs();
    }
}
