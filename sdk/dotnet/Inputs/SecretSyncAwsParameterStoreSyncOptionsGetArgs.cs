...
namespace Pulumi.Infisical.Inputs
{
    ...
    public sealed class SecretSyncAwsParameterStoreSyncOptionsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private InputList<Inputs.SecretSyncAwsParameterStoreSyncOptionsTagGetArgs>? _tags;

        /// <summary>
        /// The tags to sync to the secret
        /// </summary>
        public InputList<Inputs.SecretSyncAwsParameterStoreSyncOptionsTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.SecretSyncAwsParameterStoreSyncOptionsTagGetArgs>());
            set => _tags = value;
        }

        public SecretSyncAwsParameterStoreSyncOptionsGetArgs()
        {
        }
        public static new SecretSyncAwsParameterStoreSyncOptionsGetArgs Empty => new SecretSyncAwsParameterStoreSyncOptionsGetArgs();
    }
}
