...
namespace Pulumi.Infisical.Inputs
{
    ...
    public sealed class SecretSyncAwsSecretsManagerSyncOptionsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private InputList<Inputs.SecretSyncAwsSecretsManagerSyncOptionsTagArgs>? _tags;

        /// <summary>
        /// The tags to sync to the secret
        /// </summary>
        public InputList<Inputs.SecretSyncAwsSecretsManagerSyncOptionsTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.SecretSyncAwsSecretsManagerSyncOptionsTagArgs>());
            set => _tags = value;
        }

        public SecretSyncAwsSecretsManagerSyncOptionsArgs()
        {
        }
        public static new SecretSyncAwsSecretsManagerSyncOptionsArgs Empty => new SecretSyncAwsSecretsManagerSyncOptionsArgs();
    }
}
