...
{
    [InfisicalResourceType("infisical:index/projectEnvironment:ProjectEnvironment")]
    public partial class ProjectEnvironment : global::Pulumi.CustomResource
    {
        ...
        public ProjectEnvironment(string name, ProjectEnvironmentArgs args, CustomResourceOptions? options = null)
            : base("infisical:index/projectEnvironment:ProjectEnvironment", name, args ?? new ProjectEnvironmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ProjectEnvironment(string name, Input<string> id, ProjectEnvironmentState? state = null, CustomResourceOptions? options = null)
            : base("infisical:index/projectEnvironment:ProjectEnvironment", name, state, MakeResourceOptions(options, id))
        {
        }
